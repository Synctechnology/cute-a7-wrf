...
create_clock -period 2.000 -name clk_serdes_i -waveform {0.000 1.000} [get_ports FPGA_GCLK_P]
...
set_clock_groups -name g17 -asynchronous -group CLK_62M5_DMTD -group clk_ext_mul
